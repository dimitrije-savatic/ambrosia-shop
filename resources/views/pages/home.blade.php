        ...
        <div class="container py-5">
            <div class="row g-5 align-items-center">
                <div class="col-md-12 col-lg-7">
                    <h4 class="mb-3 text-secondary">100% Organic Greens</h4>
                    <h1 class="mb-5 display-3 text-primary">Food of Gods.</h1>
                        ...
                        <div class="carousel-inner" role="listbox">
                            <div class="carousel-item active rounded">
                                <img src="assets/img/hero-img-1.png" class="img-fluid w-100 h-100 bg-secondary rounded"
                                     alt="First slide">
                                <a href="{{route('products')}}" class="btn px-4 py-2 text-white rounded">Fruits</a>
                            </div>
                            <div class="carousel-item rounded">
                                <img src="assets/img/hero-img-2.jpg" class="img-fluid w-100 h-100 rounded"
                                     alt="Second slide">
                                <a href="{{route('products')}}" class="btn px-4 py-2 text-white rounded">Vegetables</a>
                            </div>
                        </div>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-lg-8 text-end">
                        <ul class="nav nav-pills d-inline-flex text-center mb-5">
                            <li class="nav-item">
                                <a href=""  id="all-products" class="d-flex m-2 py-2 bg-light rounded-pill active" data-bs-toggle="pill"
                                >
                            ...
                            <li class="nav-item">
                                <a href="" id="cat{{$cat->id}}" class="d-flex m-2 py-2 bg-light rounded-pill" data-bs-toggle="pill"
                                >
            ...
            <div class="row g-4 align-items-center">
                <div class="col-lg-6">
                    <div class="py-4">
                        ...
                        <p class="mb-4 text-dark">Your go-to destination for farm-fresh fruits and vegetables,
                            harvested with care to nourish and delight.</p>
    ...
    <div class="container-fluid py-5">
        <div class="container py-5">
            <div class="text-center mx-auto mb-5" style="max-width: 700px;">
                ...
                <p>Indulge in our curated selection of premium fruits and vegetables, handpicked for superior quality
                    and freshness, guaranteed to elevate your culinary experience.</p>
            </div>
            <div class="row g-4">
                    ...
                    <div class="col-lg-6 col-xl-4">
                        <div class="p-4 rounded bg-light">
                            <div class="row align-items-center">
                                <div class="col-6">
                                    <img src="assets/img/products/{{$bestSeller->image}}"
                                         class="img-fluid rounded-circle w-100" alt="{{$bestSeller->name}}">
                                </div>
                                <div class="col-6">
                                    <a href="#" class="h5">{{$bestSeller->name}}</a>
                                    ...
                                    <a href="{{route('product', $bestSeller->id)}}"
                                       class="btn border border-secondary rounded-pill px-3 text-primary"><i
    ...
    <script>
        $('#all-products').click(function (){
            ...
            $('#cat1').click(function () {
                ...
                $.ajax({
                    type: 'get',
                    url: '{{\Illuminate\Support\Facades\URL::to('/products/categories')}}',
                    data: {id: 1},
