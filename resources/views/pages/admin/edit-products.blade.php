        ...
        <div class="container mt-4 min-vh-100">
            ...
            <form action="{{route('admin.product.edit', [$product->id])}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <textarea id="description" cols="30" rows="10" class="form-control" name="description">{{$product->description}}</textarea>
                </div>
                <div class="mb-3 row">
                    @foreach($categories as $category)
                        <div class="col-md-2">
                            <input type="radio" id="rb-{{$category->name}}" value="{{$category->id}}" name="category_id" @if($product->category_id == $category->id) checked @endif/>
                ...
                <div class="mb-3">
                    ...
                    <img src="{{asset('assets/img/products/'. $product->image)}}" alt="{{$product->name}}" class="img img-size-64">
                </div>
                <div>
